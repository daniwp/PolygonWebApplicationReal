...
public class FloorMapper {
    ...
    //Made by Nicolai
    // Here we check if a building's floor number already exists
    ...
    //Here we return a list of all floors related to a building
    ...
    //Here we can delete a floor by its ID
