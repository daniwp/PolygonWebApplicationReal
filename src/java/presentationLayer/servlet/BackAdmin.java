 ...
 * @author danie
 */
@WebServlet(name = "BackAdmin", urlPatterns = {"/backadmin"})
public class BackAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int customerId = controllerFacade.getCustomerIdByBuildingId(Integer.parseInt((String)session.getAttribute("buildingId")));
