 ...
 */
@MultipartConfig
@WebServlet(name = "UploadDocument", urlPatterns = {"/uploaddocument"})
public class UploadDocument extends HttpServlet {
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String date = request.getParameter("documentDate");
            int buildingId = Integer.parseInt((String)session.getAttribute("buildingId"));

            InputStream inputStream = part.getInputStream();

            controllerFacade.saveDocument(inputStream, name, date, buildingId);
