                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 pull-right">
                        <form action="deletependingcheckup" method="POST">
                            <button onClick="return confirm('Are you sure you want to delete this floor?')" class="btn btn-danger pull-right col-md-12" type="submit">Delete item <i class="fa fa-times" aria-hidden="true"></i></button>
                            <input type="hidden" name="checkupId" value="<%= pendingCheckup.getCheckup().getCheckupId()%>"/>
                        </form>
                    </div>
                </div>
